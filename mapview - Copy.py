...
marker_1 = map_widget.set_marker(minlat, minlong, text="A", marker_color_circle='blue', marker_color_outside='green')

marker_2 = map_widget.set_marker(minlat, maxlong, text="B", marker_color_circle='blue', marker_color_outside='green')

marker_3 = map_widget.set_marker(maxlat, maxlong, text="C", marker_color_circle='blue', marker_color_outside='green')

marker_4 = map_widget.set_marker(maxlat, minlong, text="D", marker_color_circle='blue', marker_color_outside='green')
