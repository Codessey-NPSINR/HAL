            ...
            def typeuser(choice):
                ...
                if choice=="User":
                    ...
                    def find_home():
                        ...
                        submit_find_home=ctk.CTkButton(window,text="",image=img6,width=40,command=lambda:print())
                        submit_find_home.place(x=1085,y=200)
                        entry3=ctk.CTkEntry(window,placeholder_text="Central Location:",height=65,width=450,fg_color="white",placeholder_text_color="black",text_color="black")
                        entry3.place(x=720,y=115)
                        entry4=ctk.CTkEntry(window,placeholder_text="Y/N:",height=40,width=54,fg_color="white",placeholder_text_color="black",text_color="black")
                        entry4.place(x=720,y=410)
                        entry5=ctk.CTkEntry(window,placeholder_text="Y/N:",height=40,width=54,fg_color="white",placeholder_text_color="black",text_color="black")
                        entry5.place(x=720,y=450)
                        entry6=ctk.CTkEntry(window,placeholder_text="Y/N:",height=40,width=54,fg_color="white",placeholder_text_color="black",text_color="black")
                        entry6.place(x=720,y=490)
                        entry7=ctk.CTkEntry(window,placeholder_text="Y/N:",height=40,width=54,fg_color="white",placeholder_text_color="black",text_color="black")
                        entry7.place(x=720,y=530)
                        entry8=ctk.CTkEntry(window,placeholder_text="Y/N:",height=40,width=54,fg_color="white",placeholder_text_color="black",text_color="black")
                        entry8.place(x=720,y=570)
                        entry9=ctk.CTkEntry(window,placeholder_text="Y/N:",height=40,width=54,fg_color="white",placeholder_text_color="black",text_color="black")
                        entry9.place(x=720,y=610)
                        entry10=ctk.CTkEntry(window,placeholder_text="Within __ kms",height=40,width=250,fg_color="white",placeholder_text_color="black",text_color="black")
                        ...
                        black_line=ctk.CTkLabel(window,text="",image=black_line1)
